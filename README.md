...
(2) 그 중에서 개선의 여지가 있는 평균 평점의 앱들만 남긴다.

rating의 평균이 4.355578이므로 rating의 평균이 4.8~4.9 사이에 있는 앱들과 리뷰의 수가 많은 앱들만 남긴다.

결과:

|app 개수|review 개수|rating|
|-|-|-|
|개|개|111|
