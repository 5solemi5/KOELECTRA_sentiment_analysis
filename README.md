...
|app 개수|review 개수|rating 평균|
|-|-|-|
|8개|152,592개|4.370255321|

(3) 학습하는 Review의 너무 길거나 짧은 문장들은 딥러닝 학습에 무의미한 데이터들이므로 제거하는 과정을 거친다. 문장 길이가 ()인 Review만 추출한다.

(4) Review에서 한글이 아닌 리뷰, 중복, 결측치를 제거한다.

(5) Review에서 띄어쓰기가 옳바르지 않은 리뷰, 한글이 아닌 리뷰, 중복, 결측치를 제거한다.
